...
export async function GET(_request: Request, routeContext: Params) {
  try {
    ...
    return NextResponse.json({ ok: false, error: error instanceof Error ? error.message : "Falha ao consultar status." }, { status: 500 });
  }
}
