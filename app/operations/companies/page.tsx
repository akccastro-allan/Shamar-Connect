...
import { OperationsCompaniesPage } from "@/components/operations/operations-command-center";
...
export const metadata = { title: "Empresas — Centro de Comando" };
...
export default async function CompaniesPage({ searchParams }: { searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <AppShell active="operations">
      <OperationsCompaniesPage snapshot={snapshot} />
    </AppShell>
  );
}
