...
import { OperationsIntegrationsPage } from "@/components/operations/operations-command-center";
...
export const metadata = { title: "Integrações — Centro de Comando" };
...
export default async function IntegrationsPage({ searchParams }: { searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <AppShell active="operations">
      <OperationsIntegrationsPage snapshot={snapshot} />
    </AppShell>
  );
}
