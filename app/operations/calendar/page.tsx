...
import { OperationsCalendarPage } from "@/components/operations/operations-command-center";
...
export const metadata = { title: "Agenda — Centro de Comando" };
...
export default async function CalendarPage({ searchParams }: { searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <AppShell active="operations">
      <OperationsCalendarPage snapshot={snapshot} />
    </AppShell>
  );
}
