...
import { OperationsSocialPage } from "@/components/operations/operations-command-center";
...
export const metadata = { title: "Social — Centro de Comando" };
...
export default async function SocialPage({ searchParams }: { searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <AppShell active="operations">
      <OperationsSocialPage snapshot={snapshot} />
    </AppShell>
  );
}
