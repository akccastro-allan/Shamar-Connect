...
import { OperationsChannelsPage } from "@/components/operations/operations-command-center";
...
export const metadata = { title: "Canais — Centro de Comando" };
...
export default async function ChannelsPage({ searchParams }: { searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <AppShell active="operations">
      <OperationsChannelsPage snapshot={snapshot} />
    </AppShell>
  );
}
