...
import { OperationsContentPage } from "@/components/operations/operations-command-center";
...
export const metadata = { title: "Conteúdo — Centro de Comando" };
...
export default async function ContentPage({ searchParams }: { searchParams?: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <AppShell active="operations">
      <OperationsContentPage snapshot={snapshot} />
    </AppShell>
  );
}
