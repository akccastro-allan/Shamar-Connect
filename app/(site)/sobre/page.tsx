...
export const metadata: Metadata = {
  title: "Sobre",
  description: "Conheca a Moriah Systems e o proposito do ShamarConnect.",
};

const values = [
  ["Processo", "Organizar atendimento, vendas e acompanhamento comercial em uma rotina clara."],
  ["Simplicidade", "Entregar tecnologia acessivel para pequenas e medias empresas."],
  ["Crescimento", "Ajudar empresas a atender melhor, responder mais rapido e vender mais."],
  ["Controle", "Transformar conversas soltas em dados, historico e proximas acoes."],
];

const stats = [
  ["WhatsApp", "Canal principal de relacionamento com clientes"],
  ["CRM", "Funil, contatos, oportunidades e historico"],
    ...
    <main className="bg-[#F8FAFC] text-slate-950">
      <section className="bg-[#1B2F5B] px-6 py-20 text-white lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200">O ShamarConnect nasceu dentro da Moriah Systems para resolver uma dor simples: empresas dependem do WhatsApp, mas muitas ainda atendem sem processo, sem CRM e sem visao comercial.</p>
          </div>
          <div className="rounded-[2rem] border border-white/10 bg-white/10 p-8 shadow-2xl backdrop-blur">
            ...
            <h2 className="mt-4 text-3xl font-black">Software com foco em operacao real</h2>
            <p className="mt-5 leading-8 text-slate-200">A proposta e criar ferramentas praticas para empresas brasileiras organizarem atendimento, vendas, automacoes e dados em um unico ambiente.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1fr] lg:items-start">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.24em] text-[#C9952A]">Proposito</p>
            <h2 className="mt-4 text-3xl font-black tracking-tight text-[#1B2F5B] sm:text-5xl">Tirar o atendimento do improviso</h2>
            <p className="mt-6 text-lg leading-8 text-slate-600">Quando uma empresa atende pelo WhatsApp sem organizacao, oportunidades se perdem. O ShamarConnect centraliza conversas, contatos, funil, tarefas e dados para a equipe trabalhar com clareza.</p>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">O foco nao e apenas responder mensagens. E transformar cada conversa em relacionamento, oportunidade e venda acompanhada.</p>
          </div>
      ...
      <section className="px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-5xl rounded-[2rem] bg-[#1B2F5B] p-10 text-center text-white shadow-2xl">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-slate-200">Comece pelo ShamarConnect e evolua sua operacao com processo, dados e automacoes.</p>
