...
const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: MessageCircle,
    items: [
      { href: "/whatsapp-messages", label: "Atendimentos", icon: MessageCircle },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/crm", label: "CRM", icon: ContactRound, platformOnly: true },
      { href: "/pipeline", label: "Pipeline", icon: Trello, platformOnly: true },
      { href: "/sales-dashboard", label: "Dashboard de Vendas", icon: TrendingUp, platformOnly: true },
      { href: "/campaigns", label: "Campanhas", icon: Mail, platformOnly: true },
      { href: "/distribution", label: "Central de Distribuição", icon: Megaphone, platformOnly: true },
    ],
  },
  {
    label: "Automação",
    ...
    items: [
      ...
      { href: "/settings/whatsapp-automation", label: "Regras do WhatsApp", icon: SlidersHorizontal },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/settings/billing", label: "Assinatura", icon: Wallet, platformOnly: true },
      { href: "/whatsapp-diagnostics", label: "Diagnóstico WhatsApp", icon: Stethoscope, platformOnly: true },
