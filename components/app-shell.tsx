  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-950 lg:grid lg:grid-cols-[280px_1fr]">
      <aside className="hidden h-screen bg-[#1B2F5B] p-5 lg:sticky lg:top-0 lg:block">
        <SidebarContent active={active} user={user} avatarUrl={avatarUrl} isPlatformAdmin={isPlatformTenant} />
      </aside>

      <div className="min-w-0">
        <MobileNav active={active} user={user} avatarUrl={avatarUrl} isPlatformAdmin={isPlatformTenant} />
